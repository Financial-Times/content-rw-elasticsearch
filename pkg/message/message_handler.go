...
func NewMessageHandler(service es.Service, mapper *mapper.Handler, httpClient *http.Client, consumer Consumer, esClient ESClient, logger *logger.UPPLogger, evaluator evaluator) *Handler {
	indexer := &Handler{
		esService:       service,
		consumer:        consumer,
		mapper:          mapper,
